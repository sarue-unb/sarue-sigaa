...
def get_info_from_view_page(driver):
    ...
    info["categoria"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[4]/td[1]", driver)
    info["abrangencia"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[4]/td[2]", driver)

    info["ano"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[5]/td[1]", driver)
    info["periodo_realizacao"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[5]/td[2]", driver)
    info["unidade_proponente"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[6]/td", driver)  
    ...
    info["qtd_bolsas_concedidas"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[12]/td[2]", driver)
    info["tipo_cadastro"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[13]/td[1]", driver)
    info["convenio_funpec"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[13]/td[2]", driver)
    
    info["publico_alvo_interno"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[14]/td[1]", driver)
    info["publico_alvo_externo"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[14]/td[2]", driver)
    info["publico_estimado_externo"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[15]/td[1]", driver)
    info["publico_estimado_interno"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[15]/td[2]", driver)
    info["publico_real_atingido"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[16]/td", driver)
    info["fonte_financiamento"] = get_info_try_except("/html/body/div[2]/div[2]/form/table/tbody/tr[17]/td[1]", driver)

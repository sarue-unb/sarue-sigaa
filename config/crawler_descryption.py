...
TYPE_SEARCH = TYPES_SEARCH[1] if len(args) <= 3 else args[3] # 0 - PARALLEL, 1 - CONCURRENT. 2 - LINEAR
TYPE_PERIOD = TYPES_PERIOD[3] if len(args) <= 4 else args[4] # 0 - YEAR, 1 - SEMESTER, 2 - QUARTER, 3 - TRIMESTER
